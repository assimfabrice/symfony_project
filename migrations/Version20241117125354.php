 ...
 */
final class Version20241117125354 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE societe_company_type (societe_id INT NOT NULL, company_type_id INT NOT NULL, INDEX IDX_569209AFCF77503 (societe_id), INDEX IDX_569209AE51E9644 (company_type_id), PRIMARY KEY(societe_id, company_type_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
